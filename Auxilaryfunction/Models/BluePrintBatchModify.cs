...
{
    public static List<int> objIds = [];
    public static Dictionary<int, int> buildIconsDictionary = [];
    ...
    public static List<int> CurrentSelectedBuilds = [];
    ...
    public static List<int> CanModifyBuildList =
    [
        2103,//物流运输站
        2104,//星际物流运输站
        2105,//轨道采集器
    ...
    //熔炉ID
    public static List<int> SmelterIDs = [2302, 2315, 2319];
    //制造台ID
    public static List<int> AssemblerMachineIDs = [2303, 2304, 2305, 2318];
    //研究站ID
    public static List<int> LabIDs = [2901, 2902];
    //化工厂ID
    public static List<int> ChemicalIDs = [2309, 2317];

    //炮塔ID
    public static List<int> Turrets = [3001, 3002, 3003, 3004, 3005, 3010];
    public static Dictionary<int, BuildType> itemBuildTypeDic = [];
    ...
    public static List<int> turretpool = [];
    public static List<int> beltpools = [];
    public static List<int> powerexchangerpools = [];
    public static List<int> labpools = [];
    public static List<int> ejectorpools = [];
    public static List<int> powergenGammapools = [];
    public static List<int> stellarstations = [];
    public static List<int> normalstations = [];
    public static List<int> AssemblePools = [];
    public static List<int> ParticlePools = [];
    public static List<int> RefinePools = [];
    public static List<int> ChemicalPools = [];
    public static List<int> SmeltPools = [];

    public static List<int> FilterAssemblePools = [];
    public static List<int> Filterlabpools = [];
